...
var _require = __webpack_require__(/*! ./modules/playVideo */ "./src/js/modules/playVideo.js"),
    VideoPlayer = _require.default;

var _require2 = __webpack_require__(/*! ./modules/slider */ "./src/js/modules/slider.js"),
    Slider = _require2.default;

window.addEventListener('DOMContentLoaded', function () {
  var slider = new Slider('.page', '.next');
  slider.render();
  var player = new VideoPlayer('.showup .play', '.overlay');
  player.init();
});
